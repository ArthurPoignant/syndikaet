...
export default function Newsletter() {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl font-light text-black md:mb-12 sm:text-xl">Stay informed about our next releases, merch drops and parties.</p>
          <form action="#">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                  <div className="relative w-full">
                      <label htmlFor="email" className="hidden mb-2 text-sm font-medium text-black">Email address</label>
                      ...
                      <input className="block p-3 pl-10 w-full text-sm text-black bg-gray-50 rounded-lg border border-black sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500" placeholder="Enter your email" type="email" id="email" />
                  </div>
                  <div>
